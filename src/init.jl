...
function setup_externs!(mod)
    ...
    e[:jl_pointerref] = extern!(mod, "jl_pointerref", jl_value_t_ptr, LLVMType[jl_value_t_ptr, jl_value_t_ptr, jl_value_t_ptr])
    e[:jl_pointerset] = extern!(mod, "jl_pointerset", jl_value_t_ptr, LLVMType[jl_value_t_ptr, jl_value_t_ptr, jl_value_t_ptr, jl_value_t_ptr])
    ...
    for i in [Int8,Int16,Int32,Int64,Int128]
        ...
        for funsym in [:sadd, :uadd, :ssub, :usub, :smul, :umul]
            ...
            e[name] = extern!(mod, string(name), LLVM.StructType([li, int1_t], JuliaContext()), LLVMType[li, li])
        end 
...
function setup_types!(cg)
    ...
    setup_type!(jl_datatype_t_ptr, "jl_typename_type", Core.TypeName)
    setup_type!(jl_typename_t_ptr, "jl_type_typename", Type{Core.TypeName})
    ...
    setup_type!(jl_datatype_t_ptr, "jl_abstractslot_type", Core.Slot)
    setup_type!(jl_datatype_t_ptr, "jl_slotnumber_type", Core.SlotNumber)
    setup_type!(jl_datatype_t_ptr, "jl_typedslot_type", Core.TypedSlot)
    setup_type!(jl_datatype_t_ptr, "jl_simplevector_type", Core.SimpleVector)
    ...
    setup_type!(jl_datatype_t_ptr, "jl_methtable_type", Core.MethodTable)
    setup_type!(jl_datatype_t_ptr, "jl_typemap_level_type", Core.TypeMapLevel)
    setup_type!(jl_datatype_t_ptr, "jl_typemap_entry_type", Core.TypeMapEntry)
