...
fns =  [:add!, :alloca!, :and!, :array_alloca!, :ashr!, :bitcast!, :br!, :call!, :dispose, :extract_value!, :fadd!, :fcmp!, :fdiv!, :fmul!, :fneg!, :fpext!, :fptosi!, :fptoui!, :fptrunc!, :frem!, :fsub!, :gep!, :globalstring_ptr!, :icmp!, :load!, :mul!, :neg!, :not!, :or!, :position, :position!, :ret!, :sdiv!, :select!, :sext!, :sitofp!, :srem!, :store!, :struct_gep!, :sub!, :trunc!, :udiv!, :uitofp!, :urem!, :xor!, :zext!,]
for f in fns
